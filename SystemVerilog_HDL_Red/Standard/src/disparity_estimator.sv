module disparity_estimator #(
    ...
    input  wire [$clog2(IMAGE_DIM)-1:0]     derivative_row_idx_in,
    input  wire [$clog2(IMAGE_DIM)-1:0]     derivative_column_idx_in,
    ...
    localparam int unsigned DIVIDEND_W     = 33; // abs(sum_uv)[24:0] scaled by 256
    ...
    logic [$clog2(IMAGE_DIM)-1:0] row_idx_pipe     [0:DIV_ITERATIONS];
    logic [$clog2(IMAGE_DIM)-1:0] column_idx_pipe  [0:DIV_ITERATIONS];
