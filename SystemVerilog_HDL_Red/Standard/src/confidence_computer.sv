module confidence_computer #(
    ...
    logic                         valid_d1       = 1'b0;
    logic                         valid_d2       = 1'b0;
    logic [$clog2(IMAGE_DIM)-1:0] column_idx_d1  = '0;
    logic [$clog2(IMAGE_DIM)-1:0] column_idx_d2  = '0;
    logic [$clog2(IMAGE_DIM)-1:0] epi_idx_d1     = '0;
    logic [$clog2(IMAGE_DIM)-1:0] epi_idx_d2     = '0;
    ...
    function automatic logic signed [10:0] weighted_angular_derivative_q8_2(
        ...
        begin
            ...
            // Each image value is multiplied directly by the integer kernel
            // coefficient used for the Q8.2 result.
            total =
                (int'(top_left)  *  1) +
                (int'(top_mid)   *  2) +
                (int'(top_right) *  1) +
            ...
            weighted_angular_derivative_q8_2 = total;
        end
    endfunction
    ...
    function automatic logic signed [10:0] weighted_spatial_derivative_q8_2(
        ...
        begin
            ...
            weighted_spatial_derivative_q8_2 = total;
        end
    endfunction
    ...
    always_comb begin
        same_epi_window =
            ...
            (epi_column_idx_in == (column_idx_d1 + 1)) &&
            (column_idx_d1 == (column_idx_d2 + 1));
    ...
    logic [$clog2(IMAGE_DIM)-1:0] conf_meta_row_idx_0     = '0;
    logic [$clog2(IMAGE_DIM)-1:0] conf_meta_row_idx_1     = '0;
    logic [$clog2(IMAGE_DIM)-1:0] conf_meta_row_idx_2     = '0;
    logic [$clog2(IMAGE_DIM)-1:0] conf_meta_column_idx_0  = '0;
    logic [$clog2(IMAGE_DIM)-1:0] conf_meta_column_idx_1  = '0;
    logic [$clog2(IMAGE_DIM)-1:0] conf_meta_column_idx_2  = '0;
    ...
    always_ff @(posedge clk) begin : Confidence_Stage
        ...
        confidence_avg_approx <= (mag_sum / 15'd7);
