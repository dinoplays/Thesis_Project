...
if __name__ == "__main__":
    ...
    folder = "Python_RGB/Bit_Manipulation/head/cross_raw_data_png"
    out_png = convert_folder_center_crop_to_png(folder)
    print("Wrote:", out_png)

    folder = "Python_RGB/Bit_Manipulation/head/cross_data_blurred_png"
    out_png = convert_folder_center_crop_to_png(folder)
    print("Wrote:", out_png)

    folder = "Python_RGB/Bit_Manipulation/head/confidence_png"
    out_png = convert_folder_center_crop_to_png(folder)
    print("Wrote:", out_png)

    folder = "Python_RGB/Bit_Manipulation/head/confidence_robust_png"
    out_png = convert_folder_center_crop_to_png(folder)
    print("Wrote:", out_png)

    folder = "Python_RGB/Bit_Manipulation/head/disparity_png"
    out_png = convert_folder_center_crop_to_png(folder)
    print("Wrote:", out_png)

    folder = "Python_RGB/Bit_Manipulation/head/disparity_robust_png"
    out_png = convert_folder_center_crop_to_png(folder)
    print("Wrote:", out_png)
