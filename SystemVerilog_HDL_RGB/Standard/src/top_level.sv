module top_level (
	...
	localparam int unsigned RAM_ADDR_W = ($clog2(IMAGE_DIM) * 2) + 2;
	...
	logic [(($clog2(IMAGE_DIM) * 2) - 1):0] fao_shared_wr_addr [0:11];
	logic [14:0]                    fao_shared_wr_data [0:11];
	logic [(($clog2(IMAGE_DIM) * 2) - 1):0] fao_shared_rd_addr [0:11];
	...
	always_comb begin
		for (i = 0; i < 4; i = i + 1) begin
			...
			fao_shared_wr_addr_red[i]   = {{(RAM_ADDR_W - ($clog2(IMAGE_DIM) * 2)){1'b0}}, fao_shared_wr_addr[i]};
			fao_shared_wr_addr_green[i] = {{(RAM_ADDR_W - ($clog2(IMAGE_DIM) * 2)){1'b0}}, fao_shared_wr_addr[i + 4]};
			fao_shared_wr_addr_blue[i]  = {{(RAM_ADDR_W - ($clog2(IMAGE_DIM) * 2)){1'b0}}, fao_shared_wr_addr[i + 8]};
			...
			fao_shared_rd_addr_red[i]   = {{(RAM_ADDR_W - ($clog2(IMAGE_DIM) * 2)){1'b0}}, fao_shared_rd_addr[i]};
			fao_shared_rd_addr_green[i] = {{(RAM_ADDR_W - ($clog2(IMAGE_DIM) * 2)){1'b0}}, fao_shared_rd_addr[i + 4]};
			fao_shared_rd_addr_blue[i]  = {{(RAM_ADDR_W - ($clog2(IMAGE_DIM) * 2)){1'b0}}, fao_shared_rd_addr[i + 8]};
	...
	logic [$clog2(IMAGE_DIM)-1:0] epi_column_idx_out;
	logic [$clog2(IMAGE_DIM)-1:0] epi_idx_out;
	...
	logic [$clog2(IMAGE_DIM)-1:0] epi_column_idx_in;
	logic [$clog2(IMAGE_DIM)-1:0] epi_idx_in;
	...
	logic [$clog2(IMAGE_DIM)-1:0]         angular_derivative_row_idx_out_red;
	logic [$clog2(IMAGE_DIM)-1:0]         angular_derivative_column_idx_out_red;
	logic                            derivative_orientation_out_red;

	logic [$clog2(IMAGE_DIM)-1:0]         angular_derivative_row_idx_out_green;
	logic [$clog2(IMAGE_DIM)-1:0]         angular_derivative_column_idx_out_green;
	logic                            derivative_orientation_out_green;

	logic [$clog2(IMAGE_DIM)-1:0]         angular_derivative_row_idx_out_blue;
	logic [$clog2(IMAGE_DIM)-1:0]         angular_derivative_column_idx_out_blue;
	...
	logic [$clog2(IMAGE_DIM)-1:0]         confidence_row_idx_out_red;
	logic [$clog2(IMAGE_DIM)-1:0]         confidence_column_idx_out_red;
	logic                            confidence_orientation_out_red;

	logic [$clog2(IMAGE_DIM)-1:0]         confidence_row_idx_out_green;
	logic [$clog2(IMAGE_DIM)-1:0]         confidence_column_idx_out_green;
	logic                            confidence_orientation_out_green;

	logic [$clog2(IMAGE_DIM)-1:0]         confidence_row_idx_out_blue;
	logic [$clog2(IMAGE_DIM)-1:0]         confidence_column_idx_out_blue;
	...
	logic [$clog2(IMAGE_DIM)-1:0] confidence_row_idx_out;
	logic [$clog2(IMAGE_DIM)-1:0] confidence_column_idx_out;
	...
	logic [$clog2(IMAGE_DIM)-1:0]         disparity_row_idx_out_red;
	logic [$clog2(IMAGE_DIM)-1:0]         disparity_column_idx_out_red;
	logic [$clog2(IMAGE_DIM)-1:0]         disparity_row_idx_out_green;
	logic [$clog2(IMAGE_DIM)-1:0]         disparity_column_idx_out_green;
	logic [$clog2(IMAGE_DIM)-1:0]         disparity_row_idx_out_blue;
	logic [$clog2(IMAGE_DIM)-1:0]         disparity_column_idx_out_blue;
	...
	logic [$clog2(IMAGE_DIM)-1:0] disparity_row_idx_out;
	logic [$clog2(IMAGE_DIM)-1:0] disparity_column_idx_out;
