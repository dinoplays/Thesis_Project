...
module top_level_tb;
	...
	// Paths
	// ------------------------------------------------------------------------
	localparam string IN_DIR  = "/home/daniel/Thesis_Project/SystemVerilog_HDL_Red_Small/Bit_Manipulation_Throttled/tb/input_data";
	localparam string OUT_DIR = "/home/daniel/Thesis_Project/SystemVerilog_HDL_Red_Small/Bit_Manipulation_Throttled/tb/output_data";
	...
	// Depth / sizes
	// ------------------------------------------------------------------------
	localparam int MAX_DEPTH     = 100000;
	...
	logic        solf_out;
	logic        eolf_out;
	logic [5:0]  row_idx_out;
	logic [5:0]  column_idx_out;
