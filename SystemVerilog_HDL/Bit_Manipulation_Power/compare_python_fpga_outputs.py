#!/usr/bin/env python3
"""
Compare FPGA output PNGs against Python reference PNGs.

Outputs:
- Terminal summary
- Text report
- Side-by-side comparison PNGs (Python | FPGA | Normalized Difference)
...
matching bit positions between the Python and FPGA pixels, in the range [0, 8].
"""
...
PAIR_SPECS = [
    {
        ...
        "python_rel": "Python/Bit_Manipulation/headshot/confidence_png_center_128x128_png/C_avg.png",
        "fpga_rel": "SystemVerilog_HDL/Bit_Manipulation_Power/tb/output_data/fused_confidence.png",
        "kind": "confidence",
        "robust": False,
        "index": 1,
    },
    {
        ...
        "python_rel": "Python/Bit_Manipulation/headshot/disparity_png_center_128x128_png/Z_conf.png",
        "fpga_rel": "SystemVerilog_HDL/Bit_Manipulation_Power/tb/output_data/fused_weighted_disparity.png",
        "kind": "disparity",
        "robust": False,
        "index": 2,
    },
    {
        ...
        "python_rel": "Python/Bit_Manipulation/headshot/confidence_robust_png_center_128x128_png/C_avg.png",
        "fpga_rel": "SystemVerilog_HDL/Bit_Manipulation_Power/tb/output_data/fused_confidence_robust.png",
        "kind": "confidence",
        "robust": True,
        "index": 3,
    },
    {
        ...
        "python_rel": "Python/Bit_Manipulation/headshot/disparity_robust_png_center_128x128_png/Z_conf.png",
        "fpga_rel": "SystemVerilog_HDL/Bit_Manipulation_Power/tb/output_data/fused_weighted_disparity_robust.png",
        "kind": "disparity",
        "robust": True,
        "index": 4,
    },
...
def compare_one_pair(base_dir: Path, out_dir: Path, spec: dict) -> ComparisonResult:
    """Compare one Python/FPGA image pair and save the plot."""
    python_path = base_dir / spec["python_rel"]
    fpga_path = base_dir / spec["fpga_rel"]

    if not python_path.exists():
        raise FileNotFoundError(f"Missing Python image: {python_path}")
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Compare Python PNG outputs to FPGA PNG outputs.")
    parser.add_argument(
        "--base-dir",
        type=Path,
        default=default_base,
        help="Repository/project root that contains the Python/ and SystemVerilog_HDL/ folders.",
    )
    parser.add_argument(
        "--out-dir",
        type=Path,
        default=Path("SystemVerilog_HDL/Bit_Manipulation_Power/comparison_outputs"),
