...
1) normalised_png
   Python_Red/Bit_Manipulation/<dataset>/confidence_normalised_png_center_128x128_png/C_avg.png
   vs
   SystemVerilog_HDL_Red/Bit_Manipulation/tb/<dataset>/output_data/fused_confidence_normalised.png

   Python_Red/Bit_Manipulation/<dataset>/disparity_normalised_png_center_128x128_png/Z_conf_nonfilled_blurred.png
   vs
   SystemVerilog_HDL_Red/Bit_Manipulation/tb/<dataset>/output_data/fused_weighted_disparity_normalised.png

2) linear_png
   Python_Red/Bit_Manipulation/<dataset>/confidence_png_center_128x128_png/C_avg.png
   vs
   SystemVerilog_HDL_Red/Bit_Manipulation/tb/<dataset>/output_data/fused_confidence.png

   Python_Red/Bit_Manipulation/<dataset>/disparity_png_center_128x128_png/Z_conf_nonfilled_blurred.png
   vs
   SystemVerilog_HDL_Red/Bit_Manipulation/tb/<dataset>/output_data/fused_weighted_disparity.png
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--out-dir",
        type=Path,
        default=Path("SystemVerilog_HDL_Red") / "Bit_Manipulation" / "comparison_outputs_all",
