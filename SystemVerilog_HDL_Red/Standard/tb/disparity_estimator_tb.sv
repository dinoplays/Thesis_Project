...
/*
do Thesis_Project_Standard_run_dispest_tb.do
*/
...
module disparity_estimator_tb;
	...
	// Paths
	// ------------------------------------------------------------------------
	localparam string IN_DIR  = "/home/daniel/Thesis_Project/SystemVerilog_HDL_Red/Standard/tb/disp_est/input_data";
	localparam string OUT_DIR = "/home/daniel/Thesis_Project/SystemVerilog_HDL_Red/Standard/tb/disp_est/output_data";
	...
	logic [$clog2(IMAGE_DIM)-1:0] epi_column_idx_mem  [0:MAX_DEPTH-1];
	logic [$clog2(IMAGE_DIM)-1:0] epi_idx_mem         [0:MAX_DEPTH-1];
	...
	logic [$clog2(IMAGE_DIM)-1:0] ang_deriv_column_idx_mem  [0:MAX_DEPTH-1];
	logic [$clog2(IMAGE_DIM)-1:0] ang_deriv_row_idx_mem     [0:MAX_DEPTH-1];
	...
	logic [$clog2(IMAGE_DIM)-1:0]         angular_derivative_row_idx_in = '0;
	logic [$clog2(IMAGE_DIM)-1:0]         angular_derivative_column_idx_in = '0;
	...
	logic [$clog2(IMAGE_DIM)-1:0] out_disp_row_idx_mem     [0:OUT_MAX_DEPTH-1];
	logic [$clog2(IMAGE_DIM)-1:0] out_disp_col_idx_mem     [0:OUT_MAX_DEPTH-1];
