...
if __name__ == "__main__":
    folder = "Python_Red/Bit_Manipulation/dino/cross_raw_data_png"
    out_png = convert_folder_center_crop_to_png(folder)
    print("Wrote:", out_png)

    folder = "Python_Red/Bit_Manipulation/dino/cross_data_blurred_png"
    out_png = convert_folder_center_crop_to_png(folder)
    print("Wrote:", out_png)

    folder = "Python_Red/Bit_Manipulation/dino/confidence_png"
    out_png = convert_folder_center_crop_to_png(folder)
    print("Wrote:", out_png)

    folder = "Python_Red/Bit_Manipulation/dino/confidence_robust_png"
    out_png = convert_folder_center_crop_to_png(folder)
    print("Wrote:", out_png)

    folder = "Python_Red/Bit_Manipulation/dino/disparity_png"
    out_png = convert_folder_center_crop_to_png(folder)
    print("Wrote:", out_png)

    folder = "Python_Red/Bit_Manipulation/dino/disparity_robust_png"
    out_png = convert_folder_center_crop_to_png(folder)
    print("Wrote:", out_png)
    ...
    folder = "Python_Red/Bit_Manipulation/town/cross_raw_data_png"
    out_png = convert_folder_center_crop_to_png(folder)
    print("Wrote:", out_png)

    folder = "Python_Red/Bit_Manipulation/town/cross_data_blurred_png"
    out_png = convert_folder_center_crop_to_png(folder)
    print("Wrote:", out_png)

    folder = "Python_Red/Bit_Manipulation/town/confidence_png"
    out_png = convert_folder_center_crop_to_png(folder)
    print("Wrote:", out_png)

    folder = "Python_Red/Bit_Manipulation/town/confidence_robust_png"
    out_png = convert_folder_center_crop_to_png(folder)
    print("Wrote:", out_png)

    folder = "Python_Red/Bit_Manipulation/town/disparity_png"
    out_png = convert_folder_center_crop_to_png(folder)
    print("Wrote:", out_png)

    folder = "Python_Red/Bit_Manipulation/town/disparity_robust_png"
    out_png = convert_folder_center_crop_to_png(folder)
    print("Wrote:", out_png)