...
module epi_compiler_tb;
	...
	// Paths
	// ------------------------------------------------------------------------
	localparam string IN_DIR  = "/home/daniel/Thesis_Project/SystemVerilog_HDL/Bit_Manipulation/tb/epic/input_data";

	localparam string OUT_DIR_RED   = "/home/daniel/Thesis_Project/SystemVerilog_HDL/Bit_Manipulation/tb/epic/output_data/red";
