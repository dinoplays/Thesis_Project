...
/*
do Thesis_Project_Bit_Manipulation_run_tl_tb.do
*/
...
module top_level_tb;
	...
	// Clock
	// ------------------------------------------------------------------------
	localparam realtime TCLK_NS = 13.333;

	logic clock_75 = 1'b0;
	always #(TCLK_NS/2.0) clock_75 = ~clock_75;
	...
	// Paths
	// ------------------------------------------------------------------------
	localparam string IN_DIR  = "/home/daniel/Thesis_Project/SystemVerilog_HDL_RGB/Bit_Manipulation_Throttled/tb/input_data";
	localparam string OUT_DIR = "/home/daniel/Thesis_Project/SystemVerilog_HDL_RGB/Bit_Manipulation_Throttled/tb/output_data";
	...
	// ------------------------------------------------------------------------
	always_ff @(posedge clock_75) begin
