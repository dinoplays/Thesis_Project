...
if __name__ == "__main__":
    ...
    for scene in ["dino", "head", "town"]:
        ...
        # --- Paths
        cross_dir_raw = f"Python_Red/Imported_Libraries/{scene}/cross_raw_data"
        cross_dir     = f"Python_Red/Imported_Libraries/{scene}/cross_data_blurred"
        disp_dir      = f"Python_Red/Imported_Libraries/{scene}/disparity"
        conf_dir      = f"Python_Red/Imported_Libraries/{scene}/confidence"
        ...
        timing_path = os.path.join(f"Python_Red/Bit_Manipulation/{scene}", "compute_timings.txt")
        os.makedirs(f"Python_Red/Bit_Manipulation/{scene}", exist_ok=True)
