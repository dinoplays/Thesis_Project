module top_level (
	...
	logic [11:0]	epic_storage_wr_addr [0:11];
	logic [11:0]	epic_storage_wr_addr_8v;
	logic [14:0]	epic_storage_wr_data;
	logic [11:0]	epic_storage_rd_addr;
	...
	logic [11:0]	fao_shared_wr_addr [0:3];
	logic [14:0]	fao_shared_wr_data [0:3];
	logic [11:0]	fao_shared_rd_addr [0:3];
