...
if __name__ == "__main__":
    ...
    for scene in ["dino", "headshot", "town"]:
        ...
        cross_dir     = f"Python_Red/Bit_Manipulation/{scene}/cross_data_blurred"
        disp_dir      = f"Python_Red/Bit_Manipulation/{scene}/disparity"
        conf_dir      = f"Python_Red/Bit_Manipulation/{scene}/confidence"
