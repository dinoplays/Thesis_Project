...
if __name__ == "__main__":
    folder = "Python/Bit_Manipulation/headshot/cross_raw_data_png"
    out_png = convert_folder_center_crop_to_png(folder)
    print("Wrote:", out_png)

    folder = "Python/Bit_Manipulation/headshot/cross_data_blurred_png"
    out_png = convert_folder_center_crop_to_png(folder)
    print("Wrote:", out_png)

    folder = "Python/Bit_Manipulation/headshot/confidence_png"
    out_png = convert_folder_center_crop_to_png(folder)
    print("Wrote:", out_png)

    folder = "Python/Bit_Manipulation/headshot/confidence_robust_png"
    out_png = convert_folder_center_crop_to_png(folder)
    print("Wrote:", out_png)

    folder = "Python/Bit_Manipulation/headshot/disparity_png"
    out_png = convert_folder_center_crop_to_png(folder)
    print("Wrote:", out_png)

    folder = "Python/Bit_Manipulation/headshot/disparity_robust_png"
    out_png = convert_folder_center_crop_to_png(folder)
    print("Wrote:", out_png)