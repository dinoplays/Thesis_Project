...
/*
do Thesis_Project_Standard_run_confcomp_tb.do
*/
...
module confidence_computer_tb;
	...
	// Paths
	// ------------------------------------------------------------------------
	localparam string IN_DIR  = "/home/daniel/Thesis_Project/SystemVerilog_HDL_Red/Standard/tb/conf_comp/input_data";
	localparam string OUT_DIR = "/home/daniel/Thesis_Project/SystemVerilog_HDL_Red/Standard/tb/conf_comp/output_data";
	...
	logic [$clog2(IMAGE_DIM)-1:0] column_idx_mem  [0:MAX_DEPTH-1];
	...
	logic [$clog2(IMAGE_DIM)-1:0]         derivative_column_idx_out;
	logic [$clog2(IMAGE_DIM)-1:0]         derivative_row_idx_out;
	...
	logic [$clog2(IMAGE_DIM)-1:0] out_deriv_col_idx_mem     [0:OUT_MAX_DEPTH-1];
	logic [$clog2(IMAGE_DIM)-1:0] out_deriv_idx_mem         [0:OUT_MAX_DEPTH-1];
	...
	logic [$clog2(IMAGE_DIM)-1:0] out_conf_row_idx_mem     [0:OUT_MAX_DEPTH-1];
	logic [$clog2(IMAGE_DIM)-1:0] out_conf_col_idx_mem     [0:OUT_MAX_DEPTH-1];
