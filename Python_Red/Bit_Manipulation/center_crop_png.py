...
#
# Directory structure:
#   Python_Red/Bit_Manipulation/{scene}/cross_raw_data_png
#   Python_Red/Bit_Manipulation/{scene}/confidence_png
#   Python_Red/Bit_Manipulation/{scene}/confidence_normalised_png
...
ROOT = "Python_Red/Bit_Manipulation"
