#!/usr/bin/env python3
"""
Compare FPGA output PNGs against Python_RGB reference PNGs.

Outputs:
- Terminal summary
- Text report
- Side-by-side comparison PNGs (Python_RGB | FPGA | Normalized Difference)
...
matching bit positions between the Python_RGB and FPGA pixels, in the range [0, 8].
"""
...
PAIR_SPECS_DINO = [
    {
        ...
        "python_rel": "Python_RGB/Bit_Manipulation/dino/confidence_png_center_64x64_png/C_avg.png",
        "fpga_rel": "SystemVerilog_HDL_RGB/Bit_Manipulation/tb/dino/output_data/fused_confidence.png",
        "kind": "confidence",
        "robust": False,
        "index": 1,
    },
    {
        ...
        "python_rel": "Python_RGB/Bit_Manipulation/dino/disparity_png_center_64x64_png/Z_conf.png",
        "fpga_rel": "SystemVerilog_HDL_RGB/Bit_Manipulation/tb/dino/output_data/fused_weighted_disparity.png",
        "kind": "disparity",
        "robust": False,
        "index": 2,
    },
    {
        ...
        "python_rel": "Python_RGB/Bit_Manipulation/dino/confidence_robust_png_center_64x64_png/C_avg.png",
        "fpga_rel": "SystemVerilog_HDL_RGB/Bit_Manipulation/tb/dino/output_data/fused_confidence_robust.png",
        "kind": "confidence",
        "robust": True,
        "index": 3,
    },
    {
        ...
        "python_rel": "Python_RGB/Bit_Manipulation/dino/disparity_robust_png_center_64x64_png/Z_conf.png",
        "fpga_rel": "SystemVerilog_HDL_RGB/Bit_Manipulation/tb/dino/output_data/fused_weighted_disparity_robust.png",
        "kind": "disparity",
        "robust": True,
        "index": 4,
    },
...
PAIR_SPECS_HEAD = [
    {
        "name": "confidence_nonrobust",
        "python_rel": "Python_RGB/Bit_Manipulation/headshot/confidence_png_center_64x64_png/C_avg.png",
        "fpga_rel": "SystemVerilog_HDL_RGB/Bit_Manipulation/tb/headshot/output_data/fused_confidence.png",
        "kind": "confidence",
        "robust": False,
        "index": 1,
    },
    {
        "name": "disparity_nonrobust",
        "python_rel": "Python_RGB/Bit_Manipulation/headshot/disparity_png_center_64x64_png/Z_conf.png",
        "fpga_rel": "SystemVerilog_HDL_RGB/Bit_Manipulation/tb/headshot/output_data/fused_weighted_disparity.png",
        "kind": "disparity",
        "robust": False,
        "index": 2,
    },
    {
        "name": "confidence_robust",
        "python_rel": "Python_RGB/Bit_Manipulation/headshot/confidence_robust_png_center_64x64_png/C_avg.png",
        "fpga_rel": "SystemVerilog_HDL_RGB/Bit_Manipulation/tb/headshot/output_data/fused_confidence_robust.png",
        "kind": "confidence",
        "robust": True,
        "index": 3,
    },
    {
        "name": "disparity_robust",
        "python_rel": "Python_RGB/Bit_Manipulation/headshot/disparity_robust_png_center_64x64_png/Z_conf.png",
        "fpga_rel": "SystemVerilog_HDL_RGB/Bit_Manipulation/tb/headshot/output_data/fused_weighted_disparity_robust.png",
        "kind": "disparity",
        "robust": True,
        "index": 4,
    },
...
PAIR_SPECS_TOWN = [
    {
        "name": "confidence_nonrobust",
        "python_rel": "Python_RGB/Bit_Manipulation/town/confidence_png_center_64x64_png/C_avg.png",
        "fpga_rel": "SystemVerilog_HDL_RGB/Bit_Manipulation/tb/town/output_data/fused_confidence.png",
        "kind": "confidence",
        "robust": False,
        "index": 1,
    },
    {
        "name": "disparity_nonrobust",
        "python_rel": "Python_RGB/Bit_Manipulation/town/disparity_png_center_64x64_png/Z_conf.png",
        "fpga_rel": "SystemVerilog_HDL_RGB/Bit_Manipulation/tb/town/output_data/fused_weighted_disparity.png",
        "kind": "disparity",
        "robust": False,
        "index": 2,
    },
    {
        "name": "confidence_robust",
        "python_rel": "Python_RGB/Bit_Manipulation/town/confidence_robust_png_center_64x64_png/C_avg.png",
        "fpga_rel": "SystemVerilog_HDL_RGB/Bit_Manipulation/tb/town/output_data/fused_confidence_robust.png",
        "kind": "confidence",
        "robust": True,
        "index": 3,
    },
    {
        "name": "disparity_robust",
        "python_rel": "Python_RGB/Bit_Manipulation/town/disparity_robust_png_center_64x64_png/Z_conf.png",
        "fpga_rel": "SystemVerilog_HDL_RGB/Bit_Manipulation/tb/town/output_data/fused_weighted_disparity_robust.png",
        "kind": "disparity",
        "robust": True,
        "index": 4,
    },
...
def make_comparison_plot(
    ...
    cbar2.set_label("FPGA - Python_RGB")
...
def compare_one_pair(base_dir: Path, out_dir: Path, dataset_name: str, spec: dict) -> ComparisonResult:
    """Compare one Python_RGB/FPGA image pair and save the plot."""
    python_path = base_dir / spec["python_rel"]
    fpga_path = base_dir / spec["fpga_rel"]

    if not python_path.exists():
        raise FileNotFoundError(f"Missing Python_RGB image: {python_path}")
    ...
    title = f"{dataset_name} | {spec['name']} | Python_RGB vs FPGA vs Difference"
...
def format_result(result: ComparisonResult) -> str:
    ...
    lines = [
        ...
        f"Median error (FPGA - Python_RGB): {m.median_error:.6f}",
        f"Minimum error (FPGA - Python_RGB): {m.min_error}",
        f"Maximum error (FPGA - Python_RGB): {m.max_error}",
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Compare Python_RGB PNG outputs to FPGA PNG outputs.")
    parser.add_argument(
        "--base-dir",
        type=Path,
        default=default_base,
        help="Repository/project root that contains the Python_RGB/ and SystemVerilog_HDL_RGB/ folders.",
    )
    parser.add_argument(
        "--out-dir",
        type=Path,
        default=Path("SystemVerilog_HDL_RGB/Bit_Manipulation/comparison_outputs"),
