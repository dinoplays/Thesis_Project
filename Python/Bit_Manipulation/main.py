...
if __name__ == "__main__":
    ...
    for scene in ["dino", "headshot", "town"]:
        ...
        # --- Paths
        cross_dir_raw = f"Python/Bit_Manipulation/{scene}/cross_raw_data"
        cross_dir     = f"Python/Bit_Manipulation/{scene}/cross_data_blurred"
        disp_dir      = f"Python/Bit_Manipulation/{scene}/disparity"
        conf_dir      = f"Python/Bit_Manipulation/{scene}/confidence"
        ...
        bin_to_png.convert_scene_imgb_to_png(
            scene_dir=f"Python/Bit_Manipulation/{scene}",
