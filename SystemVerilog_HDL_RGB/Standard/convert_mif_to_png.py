...
BASE_DIR = "SystemVerilog_HDL_RGB/Standard/tb/bslpf_output_data"
...
EPI_BASE_DIR = "SystemVerilog_HDL_RGB/Standard/tb/epic/output_data"
...
CONF_BASE_DIR = "SystemVerilog_HDL_RGB/Standard/tb/conf_comp/output_data"
...
DISP_BASE_DIR = "SystemVerilog_HDL_RGB/Standard/tb/disp_est/output_data"
...
FAO_BASE_DIR = "SystemVerilog_HDL_RGB/Standard/tb/fao/output_data"
...
TL_BASE_DIR = "SystemVerilog_HDL_RGB/Standard/tb/output_data"
...
def twos_complement_to_int(word: int, width: int) -> int:
    """
    Convert a width-bit two's complement integer into Python_RGB int.
...
def ensure_dir(path: str) -> None:
    ...
    Time complexity:
    - O(1) for the Python_RGB call itself; filesystem dependent in practice
    """
