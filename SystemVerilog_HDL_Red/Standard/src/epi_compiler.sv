module epi_compiler #(
	...
	output logic [((2*$clog2(IMAGE_DIM))-1):0]         storage_wr_addr [0:11],
	output logic [((2*$clog2(IMAGE_DIM))-1):0]         storage_wr_addr_8v,
	output logic [7:0]                            storage_wr_data,
	output logic [((2*$clog2(IMAGE_DIM))-1):0]         storage_rd_addr,
	...
	logic [((2*$clog2(IMAGE_DIM))-1):0]  storage_wr_addr_r [0:11];
	logic [((2*$clog2(IMAGE_DIM))-1):0]  storage_wr_addr_8v_r;
	...
	logic [$clog2(IMAGE_DIM)-1:0] epi_idx_out_nm1;
	logic [$clog2(IMAGE_DIM)-1:0] epi_column_idx_out_nm1;
